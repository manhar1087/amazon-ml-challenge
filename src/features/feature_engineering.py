...
def build_features(pairs_lf: pl.LazyFrame, s1_lf: pl.LazyFrame, s23_lf: pl.LazyFrame) -> pl.DataFrame:
    s1_cols = ["entity_id", "business_name", "normalized_name", "latin_name", "business_address", "normalized_address", "postal_code", "house_number"]
