...
def build_features_v3(pairs_lf: pl.LazyFrame, s1_lf: pl.LazyFrame, s23_lf: pl.LazyFrame) -> pl.DataFrame:
    ...
    # V3 Strong Geographic Rescues & Cross-Field interactions
    df = df.with_columns([
        ...
        ((pl.col("f_postal_match") == 1.0) & (pl.col("f_house_match") == 1.0)).cast(pl.Float32).alias("f_geo_exact"),
        (pl.col("f_name_set_ratio") * ((pl.col("f_postal_match") == 1.0) & (pl.col("f_house_match") == 1.0)).cast(pl.Float32)).alias("f_rescue_geo_name_set")
    ])
